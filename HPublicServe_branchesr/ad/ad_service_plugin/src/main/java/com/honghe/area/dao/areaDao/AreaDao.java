...
public class AreaDao extends BasicDao {
    ...
    public List<Map<String, String>> list() {
        String sql = "SELECT a.id,a.name as name,a.p_id,(SELECT name FROM ad_area WHERE id = a.p_id) as p_name,a.number,a.remark,a.type_id as typeId" +
            ...
            if(campus!=null && !campus.isEmpty()){
                ...
                if(areaId!=0){
                    ...
                    for (int i = 0; i < allList.size(); i++) {
                        ...
                        menu.setType(String.valueOf(map.get("typeId")));
//                        menu.setType(String.valueOf(map.get("roomtype_id")));
                        list.add(menu);
                    }
