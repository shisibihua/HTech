        ...
        for (java.lang.reflect.Method method : methods) {
            ...
            try {
                if (method.getName().startsWith("set")) {
                    ...
                    if(data.get(field) instanceof Integer)
                    {
                        field_value = new Object[]{String.valueOf(data.get(field))};
                    }
                    else
                    {
                        field_value = new Object[]{data.get(field)};
                    }
                    method.invoke(javabean, field_value);
                }
            } catch (Exception e) {
