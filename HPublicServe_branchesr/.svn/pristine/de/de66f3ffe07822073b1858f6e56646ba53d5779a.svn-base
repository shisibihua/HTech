...
public class DeviceConfig {
    ...
    private static String SERVICE_CONNECT = "devconnect";
     ...
     * @return
     */
    public static Result deviceConnectService(String method, Map<String, String> params) throws Exception {
        params.put("cmd", SERVICE_CONNECT);
