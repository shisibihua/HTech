...
//     * @param userPath 头像路径
//     * @param userId 用户id
//     * @param userAvatar 头像名称
//     * @return
//     * @throws Exception
//     */
//    public Map<String,Object> userUpdateImage(String userPath,String userId,String userAvatar) throws Exception{
//        if(userId == null || "".equals(userId) || userPath == null || "".equals(userPath)){
//            throw new ParamException();
//        }
//        String userAvatar_ = "";
...
//        boolean flag = userDao.updateImage(userId, userAvatar_, userPath);
...
//    }
     ...
     * @throws Exception
     */
    public Object userAdd(String userPwd, String userType, String userRealName, String userName,
                          String userPath, String userAvatar, String userGender, String userBirthday, String userMobile,
                          String userEmail, String userAddress, String userNum, String userStatus,
                          String userCard, String userCourse, String userInfo) throws Exception {
     ...
     * @throws ParamException
     */
    public PageData userFamousProfessorByPage(Integer page, Integer pageSize, String queryType, String searchWord, String subjectId, String userIds, String campusId)
            throws ParamException {
