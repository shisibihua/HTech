...
public class SensitiveWordInit{
	private Logger logger=Logger.getLogger(SensitiveWordInit.class);
	...
	public Map initKeyWord(){
		try {
			...
			logger.error("敏感词库加入到HashMap中异常。",e);
		}
	...
	private Set<String> readSensitiveWordFile() throws Exception{
		Set<String> set = null;
		String filePath= WebRootUtil.getConfigFilePath("keywords.txt");  //文件路径
		logger.debug("关键字文件路径filePath："+filePath);
