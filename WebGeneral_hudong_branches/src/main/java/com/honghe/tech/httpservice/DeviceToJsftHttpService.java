...
public interface DeviceToJsftHttpService {
	 ...
	 * @author gujt
	 */
	JSONObject callConven(String url, String confID, String ip);
	 ...
	 * @author gujt
	 */
	String getConInfo(String url,String confName);

	/**
	 * 根据会议名称获取会议id
	 * @param mcuIP    mcu地址
	 * @param partyIP    终端ip
	 * @param isConven    1:改为不在线，0：在线
	 * @return
	 * @author gujt
	 */
	boolean modifyTemp(String mcuIP,String partyIP,String isConven);
	 ...
	 */
	JSONObject getTempInfo(String mcuIP,String partyIP);
}
